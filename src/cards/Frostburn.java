...
/**
 * Trieda Frostburn je reprezentácia jednej z kariet
 * @author (Marek Saniga)
 * @version (1.1)
 */
public class Frostburn extends Card implements Initial {
    /**
     * (Frostburn) Bezparametrický konštruktor, v ktorom sa inicializujú základné staty karty.
     */
    public Frostburn() {
        super("Frostburn", 3, "Lone wanderer.png", Types.NATURE, SpellType.DAMAGING, "Deal 4 damage to enemy minion, than 3 damage to enemy player");
    }
    /**
     * (Frostburn) Podľa toho či patrí karta botovi alebo hráčovi vykoná svoju činnosť.
